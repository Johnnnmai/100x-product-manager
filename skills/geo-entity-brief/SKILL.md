---
name: geo-entity-brief
title: GEO Entity Brief
type: workflow
tier: extended
pack: public-content
brand_mode: creator
public_safe: true
best_for:
  - Builders turning work into public content
  - Creators who want proof of work instead of fluff
outputs:
  - Execution plan
  - Ordered steps
  - Deliverables list
...
1. What real work or artifact is this based on?
2. Who is the audience?
3. What is the sharpest lesson or angle?
...
- xhs-proof-of-work-post

# Notes

Create a structured entity brief for durable public identity and generative search.
