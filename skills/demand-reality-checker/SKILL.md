---
name: demand-reality-checker
description: Use when a team may be confusing internal excitement with real demand and needs a harsher validity check before investing more.
title: Demand Reality Checker
type: interactive
tier: core
pack: problem-discovery
brand_mode: off
public_safe: false
best_for:
  - PMs validating whether a demand is real
  - Teams trying to reduce noisy decision making
outputs:
  - Recommendation
  - Top issues or gaps
  - Next-step plan
...
1. What is the claimed problem or demand?
2. What evidence exists today?
3. Who is most affected?
4. What decision does this work need to support?
...
- prioritization-tradeoff-advisor

# Notes

Judge whether a demand signal is real, urgent, and worth acting on.
