---
name: fallback-and-guardrail-designer
description: Use when an AI workflow can fail, drift, or create risk and you need explicit fallback behavior, constraints, and human handoff rules.
title: Fallback and Guardrail Designer
type: interactive
tier: core
pack: ai-pm-evals
brand_mode: off
public_safe: false
best_for:
  - AI PMs designing behavior and evals
  - Builders shipping AI features with real risk
outputs:
  - Recommendation
  - Top issues or gaps
  - Next-step plan
...
1. What behavior should the AI feature produce?
2. What bad behavior is unacceptable?
3. How will quality be judged?
4. When should fallback or human handoff occur?
...
Define fallback paths, blocked outputs, and handoff logic for risky AI behavior.
